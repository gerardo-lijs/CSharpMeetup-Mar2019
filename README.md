...
* [Cancellation in a WPF application demo (Source Core)](demo/04-AsyncCancelDesktop)  
...
## Notes
* In WPF desktop sample I didn't use MVVM and code directly in code behind to have a minimalistic example
